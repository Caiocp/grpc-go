...
type CategoryServiceClient interface {
	...
	CreateCategories(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoriesClient, error)
...
func (c *categoryServiceClient) CreateCategories(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoriesClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[0], "/pb.CategoryService/CreateCategories", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoriesClient{stream}
	return x, nil
}

type CategoryService_CreateCategoriesClient interface {
	Send(*CreateCategoryRequest) error
	CloseAndRecv() (*CategoryList, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoriesClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoriesClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoriesClient) CloseAndRecv() (*CategoryList, error) {
...
func (x *categoryServiceCreateCategoryBidirectionalClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}
...
type CategoryServiceServer interface {
	...
	CreateCategories(CategoryService_CreateCategoriesServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategories(CategoryService_CreateCategoriesServer) error {
...
func _CategoryService_CreateCategories_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategories(&categoryServiceCreateCategoriesServer{stream})
}

type CategoryService_CreateCategoriesServer interface {
	SendAndClose(*CategoryList) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoriesServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoriesServer) SendAndClose(m *CategoryList) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoriesServer) Recv() (*CreateCategoryRequest, error) {
...
func (x *categoryServiceCreateCategoryBidirectionalServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
